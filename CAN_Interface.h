 ...
 * out arg:     pointer to a byte location that should be updated by the function
 * retval:      void
 */
 ...
 * out argument: a pointer to a byte location to store the returned number of empty TX mailboxes
 * retval:       void
 */
 ...
 * out argument:a pointer to a byte location to store the returned pending status of the TX mailbox
 * retval:      void
 */
 ...
 * @out arg     RX_FRAME to store the received frame
 * @out arg 	DATA[] array to store the data received
 * @retval      None
 */
 ...
 * out arg:   FRAMES_NUM the returned value of stored frames in the RX_FIFO
 * retval:    void
 */
 ...
 * out arg:   status is the returned status 1 for the completion/0 for the failure
 * retval:    void
 */
